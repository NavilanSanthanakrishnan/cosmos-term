...
/// FreeType commonly represents an empty array as a null pointer with a
/// zero length. Newer Rust versions reject passing that representation
/// directly to `std::slice::from_raw_parts`.
